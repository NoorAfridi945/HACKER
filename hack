...
\033[1;94mTELEGRAM  HACKER EVIL
                  
\033[1;92mCHANNEL  HackerEvilBio
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
	    ...
	    time.sleep(2)
            ...
            os.system('xdg-https://t.me/HackerEvil1')
    else:
...
\033[1;95mTg\033[1;97mHackerEvil1"""
